...
func TestSlowSort(t *testing.T) {
	testCases := []struct {
		...
		{"Random Large", generateRandomSlice(1000)},
	}
...
func TestOptimizedStringBuilder(t *testing.T) {
	testCases := []struct {
		...
		{"Single Part", []string{"Hello"}, 5},
		{"Multiple Parts", []string{"Hello", " ", "World", "!"}, 3},
		{"Large Build", []string{"This", " ", "is", " ", "a", " ", "test"}, 10000},
	}
...
func TestHighAllocationSearch(t *testing.T) {
	testCases := []struct {
		...
		{"Long Text", strings.Repeat("The quick brown fox jumps over the lazy dog. ", 100), "fox", 100},
	}
...
func BenchmarkHighAllocationSearch(b *testing.B) {
	benchmarks := []struct {
		...
		{"Long Text", strings.Repeat("The quick brown fox jumps over the lazy dog. ", 10000), "fox"},
	}
